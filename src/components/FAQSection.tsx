...
const faqs = [
  {
    ...
    a: "ได้เงินจริง 100% ครับ Poksod-th.com เป็นเว็บป๊อกเด้งที่จ่ายจริงทุกยอด ถอนได้ไม่มีขั้นต่ำ ระบบออโต้ภายใน 3 วินาที สมาชิกกว่า 50,000 คนไว้วางใจ",
  },
  {
    q: "เว็บป๊อกเด้งที่ดีที่สุดคืออะไร?",
    a: "Poksod-th.com คือเว็บป๊อกเด้งอันดับ 1 ในไทย ด้วยระบบฝากถอนออโต้ที่เร็วที่สุด โบนัสสูงสุด 100% ระบบเสถียร ปลอดภัย และมีเกมป๊อกเด้ง 2 ใบ ให้เลือกเล่นหลากหลายรูปแบบ",
  },
  {
