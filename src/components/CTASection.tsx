    ...
    <section ref={ref} id="register" className="section-dark py-20 md:py-28">
      <div className="container max-w-2xl text-center">
        ...
        <div className="scroll-reveal flex flex-wrap justify-center gap-4" style={{ transitionDelay: "160ms" }}>
          <a href="https://lin.ee/q0LNZjp" target="_blank" rel="noopener noreferrer" className="btn-gold animate-pulse-glow text-xl px-12 py-5">
            สมัครสมาชิกเลย
          </a>
          <a href="https://lin.ee/q0LNZjp" target="_blank" rel="noopener noreferrer" className="px-12 py-5 rounded-lg font-bold text-xl border border-border text-foreground hover:bg-muted transition-all duration-300 active:scale-[0.97]">
